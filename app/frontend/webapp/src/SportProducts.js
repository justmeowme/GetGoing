...
import peeble from './rec/fittracker.jpg'
import bulfyss from './rec/bullfyss.jpg'
import walrus from './rec/walrus.jpeg'
import kore from './rec/kore.jpg'
    ...
    return (
        <div className="container py-1">
            <Container className={"d-flex justify-content-center flex-column"}>
                ...
                <span
                    style={{marginTop: 20, marginBottom: 20, backgroundColor: "#0076ce", color: "white", fontSize: 20}}>You have earned <b>400</b> points. Below are the ways to redeem your rewards.</span>
