    ...
    return (
        <>
            <Modal show={show} onHide={handleClose} animation={false}>
                ...
                <Modal.Body>
                    <div>
                        <p>As this tool is a digital platform so we care for your health download the tool to have
                            better healthier life</p>
                        <ul>
                    ...
                    <a href='https://drive.google.com/u/0/uc?id=19gsyfVi5YX3AwfjXj97PE4hYnQI6JNaY&export=download'
                       target="_blank">
